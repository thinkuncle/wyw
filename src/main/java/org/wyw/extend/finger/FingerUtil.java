...
public class FingerUtil {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(FingerUtil.fingerprint(content));
//        Runtime.getRuntime().gc();
//        long middlem = Runtime.getRunt
        Runtime.getRuntime().gc();
        long endm = Runtime.getRuntime().freeMemory();
        System.out.println(endm/1024);
        System.out.println((initm-endm)/1024);
    }
}
