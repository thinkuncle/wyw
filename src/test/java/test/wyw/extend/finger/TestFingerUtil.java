package test.wyw.extend.finger;

import org.junit.Test;
import org.wyw.extend.finger.FingerUtil;

public class TestFingerUtil {
	...
	public void test(){
        ...
        System.out.println("开始内存==============" + initm/1024);
        ...
        System.out.println(FingerUtil.fingerprint(content2));
        
        Runtime.getRuntime().gc();
        long endm = Runtime.getRuntime().freeMemory();
        System.out.println("结束内存==============" + endm/1024);
        System.out.println("消耗内存==============" + ((endm-initm)/1024));
//        23967
